      ...
      <div id="scale-container" className="canvas-scaler">
        <div id="root-frame" className="canvas style-0 ds-bg-dfdfdf" role="main" aria-label="Narrow ads canvas">
          ...
          <div id="comp-14-15" className="component abs" style={{ backgroundColor: 'transparent' }}>
            ...
            <div className="text-8-4 abs typo-23">Product type</div>
            <div className="text-8-5 abs typo-22">Name, size/weight, materials</div>
            <div className="price-8-6 abs typo-24">$00.00</div>
            <div className="frame-8-10 abs frame-center style-2 ds-radius-5">
              <div className="label-8-8 button-label typo-25">Add to cart</div>
            </div>
          ...
          <div id="comp-14-16" className="component abs">
            ...
            <div className="text-8-13 abs typo-23">Product type</div>
            <div className="text-8-14 abs typo-22">Name, materials</div>
            <div className="price-8-15 abs typo-24">$00.00</div>
            <div className="frame-8-16 abs frame-center style-2 ds-radius-5">
              <div className="label-8-17 button-label typo-25">Choose options</div>
            </div>
          ...
          <div id="comp-14-17" className="component abs">
            ...
            <div className="text-8-20 abs typo-23">Product type</div>
            <div className="text-8-21 abs typo-22">Name, size/weight, materials</div>
            <div className="price-8-22 abs typo-24">$00.00</div>
            <div className="frame-8-23 abs frame-center style-4 ds-radius-5">
              <div className="label-8-24 button-label typo-25">Sold Out</div>
            </div>
          ...
          <div id="comp-14-18" className="component abs">
            ...
            <div className="text-13-3 abs typo-23">Product type</div>
            <div className="text-13-4 abs typo-22">Name, size/weight, materials</div>
            <div className="price-13-5 abs typo-24">$00.00</div>
            <div className="frame-13-6 abs frame-center style-2 ds-radius-5">
              <div className="label-13-7 button-label typo-25">Add to cart</div>
            </div>
          ...
          <div id="comp-14-19" className="component abs">
            ...
            <div className="text-13-10 abs typo-23">Product type</div>
            <div className="text-13-11 abs typo-22">Name, materials</div>
            <div className="price-13-12 abs typo-24">$00.00</div>
            <div className="frame-13-13 abs frame-center style-2 ds-radius-5">
              <div className="label-13-14 button-label typo-25">Choose options</div>
            </div>
          ...
          <div id="comp-14-20" className="component abs">
            ...
            <div className="text-13-17 abs typo-23">Product type</div>
            <div className="text-13-18 abs typo-22">Name, size/weight, materials</div>
            <div className="price-13-19 abs typo-24">$00.00</div>
            <div className="frame-13-20 abs frame-center style-4 ds-radius-5">
              <div className="label-13-21 button-label typo-25">Sold Out</div>
            </div>
